<?php
// Simulação de dados de instrutores (em um ambiente real, viriam de um banco de dados)
$instrutores = [
    [
        'id' => 1,
        'nome' => 'Ana Paula Silva',
        'telefone' => '(31) 98765-4321',
        'email' => 'ana.silva@fiemg.com.br',
        'area_atuacao' => 'Desenvolvimento de Sistemas',
        'turmas_associadas' => [
            ['id_turma' => 1, 'codigo_turma' => 'HT-SIS-01-25-M-12700']
        ],
        'historico_aulas' => [
            ['data' => '2024-08-05', 'unidade_curricular' => 'Lógica de Programação', 'turma_codigo' => 'HT-SIS-01-24-M-12700', 'horas' => 4],
            ['data' => '2024-08-07', 'unidade_curricular' => 'Banco de Dados', 'turma_codigo' => 'HT-SIS-01-24-M-12700', 'horas' => 3],
            ['data' => '2025-07-10', 'unidade_curricular' => 'Introdução ao PHP', 'turma_codigo' => 'HT-DEV-01-25-M-12701', 'horas' => 4]
        ],
        'observacoes' => 'Especialista em Java e Python, Banco de Dados SQL.'
    ],
    [
        'id' => 2,
        'nome' => 'Juliano Fernando da Silva',
        'telefone' => '(31) 98420-4877',
        'email' => 'juliano.silva@fiemg.com.br',
        'area_atuacao' => 'Desenvolvimento de Sistemas',
        'turmas_associadas' => [
            ['id_turma' => 1, 'codigo_turma' => 'HT-SIS-01-24-M-12700']
        ],
        'historico_aulas' => [
            ['data' => '2024-08-05', 'unidade_curricular' => 'Lógica de Programação', 'turma_codigo' => 'HT-SIS-01-24-M-12700', 'horas' => 4],
            ['data' => '2024-08-07', 'unidade_curricular' => 'Banco de Dados', 'turma_codigo' => 'HT-SIS-01-24-M-12700', 'horas' => 3]
        ],
        'observacoes' => 'Especialista em Java e Python, Metodologias Ágeis.'
    ],
    [
        'id' => 3,
        'nome' => 'João Carlos Oliveira',
        'telefone' => '(31) 99876-1234',
        'email' => 'joao.oliveira@senai.com',
        'area_atuacao' => 'Informática para Internet',
        'turmas_associadas' => [
            ['id_turma' => 2, 'codigo_turma' => 'HT-IPI-01-N-12700']
        ],
        'historico_aulas' => [
            ['data' => '2025-05-15', 'unidade_curricular' => 'HTML e CSS', 'turma_codigo' => 'HT-IPI-01-N-12700', 'horas' => 5],
            ['data' => '2025-07-09', 'unidade_curricular' => 'JavaScript Avançado', 'turma_codigo' => 'HT-WEB-02-25-N-12702', 'horas' => 6]
        ],
        'observacoes' => 'Foco em desenvolvimento web front-end, JavaScript e React.'
    ],
    [
        'id' => 4,
        'nome' => 'Maria Eduarda Santos',
        'telefone' => '(31) 97654-9876',
        'email' => 'maria.santos@senai.com',
        'area_atuacao' => 'Administração',
        'turmas_associadas' => [
            ['id_turma' => 3, 'codigo_turma' => 'HT-ADM-01-M-12700']
        ],
        'historico_aulas' => [
            ['data' => '2024-09-01', 'unidade_curricular' => 'Introdução à Gestão', 'turma_codigo' => 'HT-ADM-01-M-12700', 'horas' => 4]
        ],
        'observacoes' => 'Experiência em gestão de projetos, Liderança e Marketing.'
    ],
    // Mecânica
    [
        'id' => 5,
        ...
        'email' => 'carlos.souza@senai.com',
        'area_atuacao' => 'Mecânica',
        'turmas_associadas' => [
            ['id_turma' => 4, 'codigo_turma' => 'HT-MEC-02-N-12800']
        ],
        'historico_aulas' => [
            ['data' => '2024-10-10', 'unidade_curricular' => 'Processos de Usinagem', 'turma_codigo' => 'HT-MEC-02-N-12800', 'horas' => 6]
        ],
        'observacoes' => 'Especialista em manutenção industrial e usinagem CNC.'
    ],
    [
        'id' => 6,
        'nome' => 'Fernanda Lopes Martins',
        'telefone' => '(31) 98777-2222',
        'email' => 'fernanda.martins@senai.com',
        'area_atuacao' => 'Mecânica',
        'turmas_associadas' => [],
        'historico_aulas' => [
            ['data' => '2024-11-12', 'unidade_curricular' => 'Desenho Técnico Mecânico', 'turma_codigo' => 'HT-MEC-02-N-12800', 'horas' => 4]
        ],
        'observacoes' => 'Experiência em projetos CAD e SolidWorks.'
    ],
    // Elétrica
    [
        'id' => 7,
        'nome' => 'Ricardo Almeida Pinto',
        'telefone' => '(31) 98666-3333',
        'email' => 'ricardo.pinto@senai.com',
        'area_atuacao' => 'Elétrica',
        'turmas_associadas' => [],
        'historico_aulas' => [
            ['data' => '2024-12-05', 'unidade_curricular' => 'Instalações Elétricas', 'turma_codigo' => 'HT-ELT-01-24-M-12703', 'horas' => 5]
        ],
        'observacoes' => 'Especialista em comandos elétricos e automação predial.'
    ],
    [
        'id' => 8,
        'nome' => 'Patrícia Gomes Vieira',
        'telefone' => '(31) 98555-4444',
        'email' => 'patricia.vieira@senai.com',
        'area_atuacao' => 'Elétrica',
        'turmas_associadas' => [],
        'historico_aulas' => [
            ['data' => '2025-01-15', 'unidade_curricular' => 'Eletricidade Básica', 'turma_codigo' => 'HT-ELT-01-24-M-12703', 'horas' => 4]
        ],
        'observacoes' => 'Experiência em instalações industriais e NR10.'
    ],
    // Gestão
    [
        'id' => 9,
        'nome' => 'Marcos Vinícius Braga',
        'telefone' => '(31) 98444-5555',
        'email' => 'marcos.braga@senai.com',
        'area_atuacao' => 'Gestão',
        'turmas_associadas' => [],
        'historico_aulas' => [
            ['data' => '2025-02-20', 'unidade_curricular' => 'Gestão de Pessoas', 'turma_codigo' => 'HT-ADM-01-M-12700', 'horas' => 3]
        ],
        'observacoes' => 'Consultor em RH, especialista em liderança e coaching.'
    ],
    [
        'id' => 10,
        'nome' => 'Simone Tavares Costa',
        'telefone' => '(31) 98333-6666',
        'email' => 'simone.costa@senai.com',
        'area_atuacao' => 'Gestão',
        'turmas_associadas' => [],
        'historico_aulas' => [
            ['data' => '2025-03-10', 'unidade_curricular' => 'Gestão Financeira', 'turma_codigo' => 'HT-ADM-01-M-12700', 'horas' => 4]
        ],
        'observacoes' => 'Especialista em finanças empresariais e planejamento estratégico.'
    ],
    // Automação
    [
        'id' => 11,
        'nome' => 'Eduardo Ramos Ferreira',
        'telefone' => '(31) 98222-7777',
        'email' => 'eduardo.ferreira@senai.com',
        'area_atuacao' => 'Automação',
        'turmas_associadas' => [],
        'historico_aulas' => [
            ['data' => '2025-04-05', 'unidade_curricular' => 'CLP e Sistemas Supervisórios', 'turma_codigo' => 'HT-AUT-01-25-M-12704', 'horas' => 6]
        ],
        'observacoes' => 'Experiência em Siemens, Rockwell e redes industriais.'
    ],
    [
        'id' => 12,
        'nome' => 'Tatiane Souza Lima',
        'telefone' => '(31) 98111-8888',
        'email' => 'tatiane.lima@senai.com',
        'area_atuacao' => 'Automação',
        'turmas_associadas' => [],
        'historico_aulas' => [
            ['data' => '2025-05-12', 'unidade_curricular' => 'Instrumentação Industrial', 'turma_codigo' => 'HT-AUT-01-25-M-12704', 'horas' => 5]
        ],
        'observacoes' => 'Especialista em sensores, atuadores e instrumentação.'
    ],
    // Energias Renováveis
    [
        'id' => 13,
        'nome' => 'Luiz Otávio Figueiredo',
        'telefone' => '(31) 98000-9999',
        'email' => 'luiz.figueiredo@senai.com',
        'area_atuacao' => 'Energias Renováveis',
        'turmas_associadas' => [],
        'historico_aulas' => [
            ['data' => '2025-06-18', 'unidade_curricular' => 'Energia Solar Fotovoltaica', 'turma_codigo' => 'HT-ENR-01-25-M-12705', 'horas' => 4]
        ],
        'observacoes' => 'Projetista de sistemas solares e energia limpa.'
    ],
    [
        'id' => 14,
        'nome' => 'Renata Dias Barbosa',
        'telefone' => '(31) 97999-0000',
        'email' => 'renata.barbosa@senai.com',
        'area_atuacao' => 'Energias Renováveis',
        'turmas_associadas' => [],
        'historico_aulas' => [
            ['data' => '2025-07-22', 'unidade_curricular' => 'Energia Eólica', 'turma_codigo' => 'HT-ENR-01-25-M-12705', 'horas' => 5]
        ],
        'observacoes' => 'Especialista em energia eólica e sustentabilidade.'
    ]
];

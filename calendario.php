...
<body>
   ...
   <script>
    ...
    // NOVO: Referência para o filtro de instrutor
    ...
    // NOVO: Função para preencher dinamicamente os instrutores no dropdown
    function populateInstrutorFilter() {
        // Encontra todos os nomes de instrutores únicos
        const instrutores = [...new Set(aulasData.map(aula => aula.instrutor))];
        instrutores.sort(); // Opcional: ordena em ordem alfabética

        // Limpa as opções atuais (mantendo 'Todos os Instrutores')
    ...
    function renderCalendar() {
        ...
        for (let i = 1; i <= lastDay.getDate(); i++) {
            ...
            // NOVO: Obtém o valor do filtro de instrutor
            ...
            const filteredAulas = aulasData.filter(a => {
                ...
                // NOVO: Verifica se o instrutor da aula corresponde ao filtro
                ...
                // NOVO: Adiciona a condição do filtro de instrutor
    ...
    aulaForm.addEventListener('submit', (e) => {
        ...
        if (date && codigoTurma && nomeInstrutor && sala && unidadeCurricular && turno && area) {
            ...
            // NOVO: Atualiza o filtro de instrutor após adicionar uma nova aula
    ...
    // NOVO: Adiciona o event listener para o filtro de instrutor
    instrutorFilter.addEventListener('change', () => renderCalendar());
    searchFilter.addEventListener('input', () => renderCalendar());

    document.addEventListener('DOMContentLoaded', () => {
        // NOVO: Preenche o dropdown de instrutores quando a página é carregada
        populateInstrutorFilter();
        renderCalendar();
    });
</script>
